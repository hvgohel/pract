...
public class BaseAPIController {
   ...
   * 
   * We can probably setup a spring response intercepter to do this, but I couldn't get it to work.
   * Made a bit harder because we are not using the xml config and mvc namespace.
   * 
   * @param response a non-cacheable response
   */
   ...
   * 
   * It will log the error statement, sets response code 401 and return the error message and/or
   * error code in the form of ErrorInfo.
   * 
   ...
   * 
   * It will log the error statement, sets response code 403 and return the error message and/or
   * error code in the form of ErrorInfo.
   * 
   ...
   * 
   * It will log the error statement, sets response code 404 and return the error message and/or
   * error code in the form of ErrorInfo
   * 
   * @param exception ResourceNotFoundException instance
   * @return
   */
   ...
   * 
   * It will log the error statement, sets response code 400 and return the error message and/or
   * error code in the form of ErrorInfo
   * 
   * @param exception IllegalArgumentException exception
   * @return
   */
   ...
   * 
   * It will log the error statement, sets response code 409 and return the error message and/or
   * error code in the form of ErrorInfo
   * 
   * @param exception IllegalStateException instance
   * @return
   */
   ...
   * 
   * It will log the error statement, sets response code 500 and return the error message in the
   * form of ErrorInfo
   * 
