...
/**
 * Each DAO will be based on an parameterized, abstract DAO class with support for the common
 * generic database operations.
 * 
 * @author ashvin
 * 
 * @param <T> represents entity type
 * @param <K> represents type of a primary key of an entity
 */
public interface AbstractDao<T extends Entity, K> {
   ...
   * 
   * @param entity received entity model object to save.
   */
   ...
   * 
   * @param entityId K representing unique entity id.
   */
   ...
   * 
   * @param entity received entity model object to delete.
   */
